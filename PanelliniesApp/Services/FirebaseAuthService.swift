...
final class FirebaseAuthService {
    ...
    func fetchUser(uid: String) async throws -> UserModel {
        ...
        guard snapshot.exists else { throw AuthErrorCodes.userNotFound }
    ...
    private func mapAuthError(_ error: NSError) -> AuthErrorCodes {
        ...
        case .wrongPassword: return .invalidPassword
        case .emailAlreadyInUse: return .userAlreadyExists
        case .missingEmail: return .missingParameter
